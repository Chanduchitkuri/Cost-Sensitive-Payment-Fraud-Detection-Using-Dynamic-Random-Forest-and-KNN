...
main = tkinter.Tk()
main.title("Efficient Payment Fraud Detection with Meta Learning Classifier in a Cost-Sensitive Framework") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Efficient Payment Fraud Detection with Meta Learning Classifier in a Cost-Sensitive Framework')
